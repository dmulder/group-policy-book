...
Notice that the path to the script is now pointing to an uploaded copy on the SYSVOL. If you wanted to remove this policy later, we would issue the `samba-tool gpo manage scripts startup remove` command.
