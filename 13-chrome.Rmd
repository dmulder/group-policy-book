...
![Configure the New Tab page URL](chrome-images/url.png)
...
=================================================================
  CSE: gp_chromium_ext
  -----------------------------------------------------------
    Policy Type: Software\Policies\Google\Chrome\HomepageIsNewTabPage
    -----------------------------------------------------------
      1
    -----------------------------------------------------------
    Policy Type: Software\Policies\Google\Chrome\NewTabPageLocation
    -----------------------------------------------------------
      https://samba.org
    -----------------------------------------------------------
    Policy Type: Software\Policies\Google\Chrome\RestoreOnStartup
    -----------------------------------------------------------
      5
    -----------------------------------------------------------
  -----------------------------------------------------------
  ...
  <user name="TESTSYSDM$">
    <guid value="{31B2F340-016D-11D2-945F-00C04FB984F9}">
      ...
      <gp_ext name="Google/Chromium">
        <attribute name="recommended">9327a492264ecac0806b031b780241d86cabe38348fe49c4c5a610ee584cfbaaefd3fdffd1b1b54c9ee225820433a7f902c688b2e123181a56c73b9cbf9cd13f:/etc/chromium/policies/recommended/gp_g4_82tuo.json</attribute>
        <attribute name="managed">d452dda8cab875a24b57b6a57ee90bbf71519585ef4c76f2ac71d570749849290da3d15241e6cd09806943a9d9aaaaf18c219d8e7dd47a3c5a809b570b621935:/etc/chromium/policies/managed/gp_l_k9uvxk.json</attribute>
      </gp_ext>
      <gp_ext name="Google/Chrome">
        <attribute name="recommended">9327a492264ecac0806b031b780241d86cabe38348fe49c4c5a610ee584cfbaaefd3fdffd1b1b54c9ee225820433a7f902c688b2e123181a56c73b9cbf9cd13f:/etc/opt/chrome/policies/recommended/gp_7p6q0bxf.json</attribute>
        <attribute name="managed">d452dda8cab875a24b57b6a57ee90bbf71519585ef4c76f2ac71d570749849290da3d15241e6cd09806943a9d9aaaaf18c219d8e7dd47a3c5a809b570b621935:/etc/opt/chrome/policies/managed/gp_fcthg4bc.json</attribute>
      </gp_ext>
    </guid>
    <applylog>
...
![Chrome with default homepage](chrome-images/chrome-homepage.png)
...
![Chrome settings](chrome-images/chrome-settings.png)
