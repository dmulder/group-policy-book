...
![IIS Manager](cert-auto-enroll-images/bindings.png)

Highlight the https binding, then select `Edit...`. Select the correct SSL certificate, then click OK to save.

![Edit Site Binding](cert-auto-enroll-images/edit-binding.png)
...
![Issued Certificates](cert-auto-enroll-images/issued-certs.png)
